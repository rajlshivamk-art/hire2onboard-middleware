    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "w-full max-w-lg",
          "bg-slate-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 rounded-lg p-1.5
            text-white/50 hover:text-white hover:bg-cyan-500/20
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-white text-lg font-medium leading-none", className)}
      {...props}
    />
  )
}
